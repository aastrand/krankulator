...
impl Lookup {
    pub fn new() -> Lookup {
        ...
        lookup[ADC_ZPX as usize] = &Opcode {
            // (ADd with Carry)
            name: "ADC_ZPX",
            size: 2,
            cycles: 4,
        ...
        lookup[ADC_ABS as usize] = &Opcode {
            // (ADd with Carry)
            name: "ADC_ABS",
            size: 3,
            cycles: 4,
        ...
        lookup[ADC_ABX as usize] = &Opcode {
            // (ADd with Carry)
            name: "ADC_ABX",
            size: 3,
            cycles: 4,
        ...
        lookup[ADC_ABY as usize] = &Opcode {
            // (ADd with Carry)
            name: "ADC_ABY",
            size: 3,
            cycles: 4,
        ...
        lookup[ADC_INX as usize] = &Opcode {
            // (ADd with Carry)
            name: "ADC_INX",
            size: 2,
            cycles: 6,
        ...
        lookup[ADC_INY as usize] = &Opcode {
            // (ADd with Carry)
            name: "ADC_INY",
            size: 2,
            cycles: 5,
        ...
        lookup[AND_ABS as usize] = &Opcode {
            // (bitwise AND with accumulator)
            name: "AND_ABS",
            size: 3,
            cycles: 4,
        ...
        lookup[AND_ABX as usize] = &Opcode {
            // (bitwise AND with accumulator)
            name: "AND_ABX",
            size: 3,
            cycles: 4,
        ...
        lookup[AND_ABY as usize] = &Opcode {
            // (bitwise AND with accumulator)
            name: "AND_ABY",
            size: 3,
            cycles: 4,
        ...
        lookup[AND_INX as usize] = &Opcode {
            // (bitwise AND with accumulator)
            name: "AND_INX",
            size: 2,
            cycles: 6,
        ...
        lookup[AND_INY as usize] = &Opcode {
            // (bitwise AND with accumulator)
            name: "AND_INY",
            size: 2,
            cycles: 5,
        ...
        lookup[ASL_ZPX as usize] = &Opcode {
            // (Arithmetic Shift Left)
            name: "ASL_ZPX",
            size: 2,
            cycles: 6,
        ...
        lookup[ASL_ABS as usize] = &Opcode {
            // (Arithmetic Shift Left)
            name: "ASL_ABS",
            size: 3,
            cycles: 6,
        ...
        lookup[ASL_ABX as usize] = &Opcode {
            // (Arithmetic Shift Left)
            name: "ASL_ABX",
            size: 3,
            cycles: 7,
        ...
        lookup[BIT_ABS as usize] = &Opcode {
            // (test BITs)
            name: "BIT_ABS",
            size: 3,
            cycles: 4,
        ...
        lookup[CMP_ZPX as usize] = &Opcode {
            // (CoMPare accumulator)
            name: "CMP_ZPX",
            size: 2,
            cycles: 4,
        ...
        lookup[CMP_ABX as usize] = &Opcode {
            // (CoMPare accumulator)
            name: "CMP_ABX",
            size: 3,
            cycles: 4,
        ...
        lookup[CMP_ABY as usize] = &Opcode {
            // (CoMPare accumulator)
            name: "CMP_ABY",
            size: 3,
            cycles: 4,
        ...
        lookup[CMP_INX as usize] = &Opcode {
            // (CoMPare accumulator)
            name: "CMP_INX",
            size: 2,
            cycles: 6,
        ...
        lookup[CMP_INY as usize] = &Opcode {
            // (CoMPare accumulator)
            name: "CMP_INY",
            size: 2,
            cycles: 5,
        ...
        lookup[DEC_ZPX as usize] = &Opcode {
            // (DECrement memory)
            name: "DEC_ZPX",
            size: 2,
            cycles: 6,
        ...
        lookup[DEC_ABS as usize] = &Opcode {
            // (DECrement memory)
            name: "DEC_ABS",
            size: 3,
            cycles: 6,
        ...
        lookup[DEC_ABX as usize] = &Opcode {
            // (DECrement memory)
            name: "DEC_ABX",
            size: 3,
            cycles: 7,
        ...
        lookup[INC_ZPX as usize] = &Opcode {
            // (INCrement memory)
            name: "INC_ZPX",
            size: 2,
            cycles: 6,
        ...
        lookup[INC_ABS as usize] = &Opcode {
            // (INCrement memory)
            name: "INC_ABS",
            size: 3,
            cycles: 6,
        ...
        lookup[INC_ABX as usize] = &Opcode {
            // (INCrement memory)
            name: "INC_ABX",
            size: 3,
            cycles: 7,
        ...
        lookup[JSR_ABS as usize] = &Opcode {
            // (Jump to SubRoutine)
            name: "JSR_ABS",
            size: 3,
            cycles: 6,
        ...
        lookup[LDX_ABY as usize] = &Opcode {
            // (LoaD X register)
            name: "LDX_ABY",
            size: 3,
            cycles: 4,
        ...
        lookup[LDY_ZPX as usize] = &Opcode {
            // (LoaD Y register)
            name: "LDY_ZPX",
            size: 2,
            cycles: 4,
        ...
        lookup[LDY_ABX as usize] = &Opcode {
            // (LoaD Y register)
            name: "LDY_ABX",
            size: 3,
            cycles: 4,
        ...
        lookup[LSR_ZPX as usize] = &Opcode {
            // (Logical Shift Right)
            name: "LSR_ZPX",
            size: 2,
            cycles: 6,
        ...
        lookup[LSR_ABS as usize] = &Opcode {
            // (Logical Shift Right)
            name: "LSR_ABS",
            size: 3,
            cycles: 6,
        ...
        lookup[LSR_ABX as usize] = &Opcode {
            // (Logical Shift Right)
            name: "LSR_ABX",
            size: 3,
            cycles: 7,
        ...
        lookup[ORA_ZPX as usize] = &Opcode {
            // (bitwise OR with Accumulator)
            name: "ORA_ZPX",
            size: 2,
            cycles: 4,
        ...
        lookup[ORA_ABS as usize] = &Opcode {
            // (bitwise OR with Accumulator)
            name: "ORA_ABS",
            size: 3,
            cycles: 4,
        ...
        lookup[ORA_ABX as usize] = &Opcode {
            // (bitwise OR with Accumulator)
            name: "ORA_ABX",
            size: 3,
            cycles: 4,
        ...
        lookup[ORA_ABY as usize] = &Opcode {
            // (bitwise OR with Accumulator)
            name: "ORA_ABY",
            size: 3,
            cycles: 4,
        ...
        lookup[ORA_INX as usize] = &Opcode {
            // (bitwise OR with Accumulator)
            name: "ORA_INX",
            size: 2,
            cycles: 6,
        ...
        lookup[ORA_INY as usize] = &Opcode {
            // (bitwise OR with Accumulator)
            name: "ORA_INY",
            size: 2,
            cycles: 5,
        ...
        lookup[ROL_ZPX as usize] = &Opcode {
            // (ROtate Left)
            name: "ROL_ZPX",
            size: 2,
            cycles: 6,
        ...
        lookup[ROL_ABS as usize] = &Opcode {
            // (ROtate Left)
            name: "ROL_ABS",
            size: 3,
            cycles: 6,
        ...
        lookup[ROL_ABX as usize] = &Opcode {
            // (ROtate Left)
            name: "ROL_ABX",
            size: 3,
            cycles: 7,
        ...
        lookup[ROR_ZPX as usize] = &Opcode {
            // (ROtate Right)
            name: "ROR_ZPX",
            size: 2,
            cycles: 6,
        ...
        lookup[ROR_ABS as usize] = &Opcode {
            // (ROtate Right)
            name: "ROR_ABS",
            size: 3,
            cycles: 6,
        ...
        lookup[ROR_ABX as usize] = &Opcode {
            // (ROtate Right)
            name: "ROR_ABX",
            size: 3,
            cycles: 7,
        ...
        lookup[SBC_ZPX as usize] = &Opcode {
            // (SuBtract with Carry)
            name: "SBC_ZPX",
            size: 2,
            cycles: 4,
        ...
        lookup[SBC_ABS as usize] = &Opcode {
            // (SuBtract with Carry)
            name: "SBC_ABS",
            size: 3,
            cycles: 4,
        ...
        lookup[SBC_ABX as usize] = &Opcode {
            // (SuBtract with Carry)
            name: "SBC_ABX",
            size: 3,
            cycles: 4,
        ...
        lookup[SBC_ABY as usize] = &Opcode {
            // (SuBtract with Carry)
            name: "SBC_ABY",
            size: 3,
            cycles: 4,
        ...
        lookup[SBC_INX as usize] = &Opcode {
            // (SuBtract with Carry)
            name: "SBC_INX",
            size: 2,
            cycles: 6,
        ...
        lookup[SBC_INY as usize] = &Opcode {
            // (SuBtract with Carry)
            name: "SBC_INY",
            size: 2,
            cycles: 5,
        ...
        lookup[STA_ABX as usize] = &Opcode {
            // (STore Accumulator)
            name: "STA_ABX",
            size: 3,
            cycles: 5,
        ...
        lookup[STX_ZPY as usize] = &Opcode {
            // (STore X register)
            name: "STX_ZPY",
            size: 2,
            cycles: 4,
        ...
        lookup[STY_ZPX as usize] = &Opcode {
            // (STore Y register)
            name: "STY_ZPX",
            size: 2,
            cycles: 4,
        ...
        lookup[LAX_INX as usize] = &Opcode {
            // LAX = LDA + LDX (Unofficial opcode)
            name: "LAX_INX",
            size: 2,
            cycles: 6,
            mode: ADDR_MODE_INX,
        ...
        lookup[LAX_ABS as usize] = &Opcode {
            // LAX = LDA + LDX (Unofficial opcode)
            name: "LAX_ABS",
            size: 3,
            cycles: 4,
        ...
        lookup[LAX_INY as usize] = &Opcode {
            // LAX = LDA + LDX (Unofficial opcode)
            name: "LAX_INY",
            size: 2,
            cycles: 5,
        ...
        lookup[LAX_ZPY as usize] = &Opcode {
            // LAX = LDA + LDX (Unofficial opcode)
            name: "LAX_ZPY",
            size: 2,
            cycles: 4,
        ...
        lookup[LAX_ABY as usize] = &Opcode {
            // LAX = LDA + LDX (Unofficial opcode)
            name: "LAX_ABY",
            size: 3,
            cycles: 4,
        ...
        lookup[SAX_INX as usize] = &Opcode {
        ...
        lookup[SAX_ABS as usize] = &Opcode {
            // SAX = Store A&X (Unofficial opcode)
            name: "SAX_ABS",
            size: 3,
            cycles: 4,
        ...
        lookup[SAX_ZPY as usize] = &Opcode {
            // SAX = Store A&X (Unofficial opcode)
            name: "SAX_ZPY",
            size: 2,
            cycles: 4,
        ...
        lookup[SNC_IMM as usize] = &Opcode {
            // SNC = SBC + NOP (Unofficial opcode)
            name: "SNC_IMM",
            size: 2,
            cycles: 2,
            mode: ADDR_MODE_IMM,
        ...
        lookup[DCP_INX as usize] = &Opcode {
        ...
        lookup[DCP_ABS as usize] = &Opcode {
            // DCP = DEC + CMP (Unofficial opcode)
            name: "DCP_ABS",
            size: 3,
            cycles: 6,
        ...
        lookup[DCP_INY as usize] = &Opcode {
            // DCP = DEC + CMP (Unofficial opcode)
            name: "DCP_INY",
            size: 2,
            cycles: 8,
        ...
        lookup[DCP_ABY as usize] = &Opcode {
            // DCP = DEC + CMP (Unofficial opcode)
            name: "DCP_ABY",
            size: 3,
            cycles: 7,
        ...
        lookup[ISB_ABS as usize] = &Opcode {
            // ISB = INC + SBC (Unofficial opcode)
            name: "ISB_ABS",
            size: 3,
            cycles: 6,
        ...
        lookup[ISB_INY as usize] = &Opcode {
            // ISB = INC + SBC (Unofficial opcode)
            name: "ISB_INY",
            size: 2,
            cycles: 8,
        ...
        lookup[ISB_ABY as usize] = &Opcode {
            // ISB = INC + SBC (Unofficial opcode)
            name: "ISB_ABY",
            size: 3,
            cycles: 7,
        ...
        lookup[SLO_ABS as usize] = &Opcode {
            // SLO = ASL + ORA (Unofficial opcode)
            name: "SLO_ABS",
            size: 3,
            cycles: 6,
        ...
        lookup[SLO_INY as usize] = &Opcode {
            // SLO = ASL + ORA (Unofficial opcode)
            name: "SLO_INY",
            size: 2,
            cycles: 8,
        ...
        lookup[SLO_ABY as usize] = &Opcode {
            // SLO = ASL + ORA (Unofficial opcode)
            name: "SLO_ABY",
            size: 3,
            cycles: 7,
        ...
        lookup[RLA_ABS as usize] = &Opcode {
            // RLA = ROL + AND (Unofficial opcode)
            name: "RLA_ABS",
            size: 3,
            cycles: 6,
        ...
        lookup[RLA_INY as usize] = &Opcode {
            // RLA = ROL + AND (Unofficial opcode)
            name: "RLA_INY",
            size: 2,
            cycles: 8,
        ...
        lookup[RLA_ABY as usize] = &Opcode {
            // RLA = ROL + AND (Unofficial opcode)
            name: "RLA_ABY",
            size: 3,
            cycles: 7,
        ...
        lookup[SRE_ABS as usize] = &Opcode {
            // SRE = LSR + EOR (Unofficial opcode))
            name: "SRE_ABS",
            size: 3,
            cycles: 6,
        ...
        lookup[SRE_INY as usize] = &Opcode {
            // SRE = LSR + EOR (Unofficial opcode)
            name: "SRE_INY",
            size: 2,
            cycles: 8,
        ...
        lookup[SRE_ABY as usize] = &Opcode {
            // SRE = LSR + EOR (Unofficial opcode)
            name: "SRE_ABY",
            size: 3,
            cycles: 7,
        ...
        lookup[RRA_ABS as usize] = &Opcode {
            // RRA = ROR + ADC (Unofficial opcode)
            name: "RRA_ABS",
            size: 3,
            cycles: 6,
        ...
        lookup[RRA_INY as usize] = &Opcode {
            // RRA = ROR + ADC (Unofficial opcode)
            name: "RRA_INY",
            size: 2,
            cycles: 8,
        ...
        lookup[RRA_ABY as usize] = &Opcode {
            // RRA = ROR + ADC (Unofficial opcode)
            name: "RRA_ABY",
            size: 3,
            cycles: 7,
        ...
        lookup[N3C_ABX as usize] = &Opcode {
            // NOP (Unofficial opcode)
            name: "N3C_ABX",
            size: 3,
            cycles: 4,
        ...
        lookup[N5C_ABX as usize] = &Opcode {
            // NOP (Unofficial opcode)
            name: "N5C_ABX",
            size: 3,
            cycles: 4,
        ...
        lookup[N7C_ABX as usize] = &Opcode {
            // NOP (Unofficial opcode)
            name: "N7C_ABX",
            size: 3,
            cycles: 4,
        ...
        lookup[NDC_ABX as usize] = &Opcode {
            // NOP (Unofficial opcode)
            name: "NDC_ABX",
            size: 3,
            cycles: 4,
        ...
        lookup[NFC_ABX as usize] = &Opcode {
            // NOP (Unofficial opcode)
            name: "NFC_ABX",
            size: 3,
            cycles: 4,
        ...
        lookup[NOP_14 as usize] = &Opcode {
            // NOP zpx (Unofficial opcode)
            name: "NOP_14",
            size: 2,
            cycles: 4,
            mode: ADDR_MODE_ZPX,
