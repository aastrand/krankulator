...
def main():
    ...
    opcodes["SLO_INY"] = ("13", 2, 8, "SLO = ASL + ORA (Unofficial opcode)")
    ...
    opcodes["SLO_ABY"] = ("1b", 3, 7, "SLO = ASL + ORA (Unofficial opcode)")
    # F01A  1F 48 05 *SLO $0548,X @ 0647 = A5         A:B3 X:FF Y:D1 P:E4 SP:FB PPU:187,298 CYC:21355
    opcodes["SLO_ABX"] = ("1f", 3, 7, "SLO = ASL + ORA (Unofficial opcode)")
    ...
    opcodes["RLA_INY"] = ("33", 2, 8, "RLA = ROL + AND (Unofficial opcode)")
    ...
    opcodes["RLA_ABY"] = ("3b", 3, 7, "RLA = ROL + AND (Unofficial opcode)")
    # F28A  3F 48 05 *RLA $0548,X @ 0647 = A5         A:B3 X:FF Y:E6 P:E4 SP:FB PPU:202,154 CYC:23012
    opcodes["RLA_ABX"] = ("3f", 3, 7, "RLA = ROL + AND (Unofficial opcode)")
    ...
    opcodes["SRE_INY"] = ("53", 2, 8, "SRE = LSR + EOR (Unofficial opcode)")
    ...
    opcodes["SRE_ABY"] = ("5b", 3, 7, "SRE = LSR + EOR (Unofficial opcode)")
    # F4FA  5F 48 05 *SRE $0548,X @ 0647 = A5         A:B3 X:FF Y:FB P:E4 SP:FB PPU:216,339 CYC:24665
    opcodes["SRE_ABX"] = ("5f", 3, 7, "SRE = LSR + EOR (Unofficial opcode)")
    ...
    opcodes["RRA_INY"] = ("73", 2, 8, "RRA = ROR + ADC (Unofficial opcode)")
    ...
    opcodes["RRA_ABY"] = ("7b", 3, 7, "RRA = ROR + ADC (Unofficial opcode)")
    # F76A  7F 48 05 *RRA $0548,X @ 0647 = A5         A:B2 X:FF Y:13 P:E4 SP:FB PPU:231,138 CYC:26303
    opcodes["RRA_ABX"] = ("7f", 3, 7, "RRA = ROR + ADC (Unofficial opcode)")
